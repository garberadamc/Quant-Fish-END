...
`devtools::install_github("jrosen48/pisaUSA15")`; `library(pisaUSA15)`; `open_codebook()`
...
**Variance/covariance specification decisions in LPA modeling**
...
*Figure*. Picture of variance/covariance matrix adapted from tutorial by Rosenberg (2019).
...
lpa_enum_fit <- mplusModeler(lpa_enum, 
                dataout=here("15-LPA", "enum_lpa", "lpa_lsay.dat"),
                modelout=glue(here("15-LPA", "enum_lpa", "c{k}_lpa_lsay.inp")) ,
...
Compare model fit.
```{r}
all_output <- readModels(here("15-LPA", "enum_lpa"), quiet = TRUE)
