...
patterns_fit <- mplusModeler(patterns,
                dataout=here("13-response-patterns", "mplus_files", "LSAY.dat"),
                modelout=here("13-response-patterns", "mplus_files", "patterns.inp") ,
...
patterns <- read_table2(here("13-response-patterns", "mplus_files", "resp_patterns.dat"),
                        col_names=FALSE, na = "*")                                                   
